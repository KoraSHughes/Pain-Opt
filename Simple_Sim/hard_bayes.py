...
def acquisition(mu, sigma, best, xi=0.2):
...
def BO_loop(opt_trials=25,
    ...
    kernel = RBF([10.0, 10.0], length_scale_bounds=(1e-2, 1e3))
    ...
    X = latin_hypercube(3, amp_bounds, pw_bounds)
...
if __name__ == "__main__":
    history = BO_loop(opt_trials=25)   # change trials as you like
